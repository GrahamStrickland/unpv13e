...
int mcast_leave(int sockfd, const SA *grp, socklen_t grplen) {
  ...
  return (setsockopt(sockfd, family_to_level(grp->sa_family), MCAST_LEAVE_GROUP,
                     &req, sizeof(req)));
#else
  ...
  case AF_INET: {
    ...
    return (setsockopt(sockfd, IPPROTO_IP, IP_DROP_MEMBERSHIP, &mreq,
                       sizeof(mreq)));
  }
...
#define IPV6_LEAVE_GROUP IPV6_DROP_MEMBERSHIP
  ...
  case AF_INET6: {
    ...
    return (setsockopt(sockfd, IPPROTO_IPV6, IPV6_LEAVE_GROUP, &mreq6,
                       sizeof(mreq6)));
  }
#endif
...
int mcast_leave_source_group(int sockfd, const SA *src, socklen_t srclen,
  ...
  case AF_INET: {
    ...
    return (setsockopt(sockfd, IPPROTO_IP, IP_DROP_SOURCE_MEMBERSHIP, &mreq,
                       sizeof(mreq)));
  }
#endif
